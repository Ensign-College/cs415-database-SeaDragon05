...
-- UserPhone
INSERT INTO UserPhone(user_phone_id, phone_type_id, web_user_id, phone_number, created_date)
VALUES
    (1,1,1,'801-555-1234',CURRENT_TIMESTAMP,'1'),
    (2,2,1,'801-555-5678',CURRENT_TIMESTAMP,'1'),
    (3,3,1,'801-555-9012',CURRENT_TIMESTAMP,'1'),
    (4,1,2,'801-555-3456',CURRENT_TIMESTAMP,'1');
ALTER SEQUENCE UserPhone_user_phone_id_seq RESTART WITH 5;

-- UserInfo
INSERT INTO UserInfo(user_info_id, web_user_id, profile_bio, profile_picture, date_of_birth, created_date)
VALUES
